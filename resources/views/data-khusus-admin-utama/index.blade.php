...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Data Khusus OPD</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/admin/dashboard">Home</a></li>
                    <li class="breadcrumb-item active">Data Khusus OPD</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-3">
                            <div class="card shadow" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/admin/data-khusus-admin-utama/grafik" class="btn btn-primary">Lihat</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card shadow" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="/admin/data-khusus-admin-utama/tabel" class="btn btn-primary">Lihat</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
