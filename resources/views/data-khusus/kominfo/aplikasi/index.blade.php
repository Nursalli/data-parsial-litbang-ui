        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-success" href="/admin/data-khusus/aplikasi/tambah" role="button"
                        title="Tambah Aplikasi">
                        <i class="fas fa-plus"> Tambah Aplikasi</i>
                    </a>
                    @endif
                        ...
                        <tbody>
                            ...
                            @php while ($i < 5) { @endphp <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-warning mb-1" href="/admin/data-khusus/aplikasi/ubah"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title text-center" id="judulModal">Hapus Aplikasi</h4>
