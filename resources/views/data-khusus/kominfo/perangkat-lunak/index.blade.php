...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Data Perangkat Lunak</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="/admin/dashboard">Home</a></li>
                    <li class="breadcrumb-item active">Data Perangkat Lunak</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-success" href="/admin/data-khusus/perangkat-lunak/tambah" role="button"
                        title="Tambah Perangkat Lunak">
                        <i class="fas fa-plus"> Tambah Perangkat Lunak</i>
                    </a>
                    @endif
                        ...
                        <tbody>
                            ...
                            @php while ($i < 5) { @endphp <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-warning mb-1" href="/admin/data-khusus/perangkat-lunak/ubah"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title text-center" id="judulModal">Hapus Perangkat Lunak</h4>
