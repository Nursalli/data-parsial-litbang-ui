...
<head>
    ...
    <title>Login &mdash; Data Parsial Provinsi Papua Barat</title>
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch" style="background-image: url('{!! asset('img/bg.jpg') !!}');">
                    ...
                    <div class="p-4 m-3">
                        ...
                        <form method="post" action="/admin/login" class="needs-validation" novalidate="">
                            ...
                            <div class="form-group text-center">
                                ...
                                <button type="submit" class="btn btn-login btn-lg btn-icon icon-right" tabindex="4">
                                    Login
                                </button>
                            </div>
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; Geng Raja Ampat.
                            <div class="mt-2">
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
                    data-background="{!! asset('img/cover.jpg') !!}">
